# Point of Sale (POS) and Invoicing System for LG Packaging-- (PROTOTYPE)
...
- Modular design   
- Functional database integration with real-time updates etc.
- Report generation linked to data from the database 
- Interface tailored for staff usability and clarity
- Streamlining of the invoicing process and option to print
